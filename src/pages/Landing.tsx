     ...
     <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      {/* Header */}
       <motion.header 
         ...
         className="border-b border-border/30 bg-background/70 backdrop-blur-2xl sticky top-0 z-50"
       >
      ...
      {/* Hero Section */}
       <section className="container mx-auto px-4 pt-8 pb-12 sm:pt-12 sm:pb-16 md:py-20 lg:py-24 relative">
        ...
        >
           ...
           >
             ...
             <span className="relative">
               ...
               <motion.span 
                 className="absolute -bottom-1 left-0 right-0 h-1 bg-gradient-to-r from-primary to-primary/50 rounded-full"
                 initial={{ scaleX: 0 }}
                 animate={{ scaleX: 1 }}
        ...
        <motion.div 
           ...
           className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mt-10 sm:mt-12 md:mt-16 max-w-3xl mx-auto"
        >
          {stats.map((stat, index) => (
            <motion.div 
              key={index} 
               className="text-center p-3 sm:p-4 md:p-5 rounded-2xl bg-card/60 backdrop-blur-sm border border-border/50 hover:border-primary/40 hover:bg-card/80 transition-all duration-300 group"
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              transition={{ duration: 0.4, delay: index * 0.1 }}
               whileHover={{ y: -6, scale: 1.02 }}
               whileTap={{ scale: 0.98 }}
               className={plan.popular ? 'sm:col-span-2 lg:col-span-1 lg:-mt-4 lg:mb-4 order-first lg:order-none' : ''}
            >
      ...
      {/* CTA Section */}
       <section className="container mx-auto px-4 py-12 sm:py-16 md:py-20 lg:py-24">
        <motion.div 
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
           className="bg-gradient-to-br from-primary via-primary to-primary/90 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 text-center text-primary-foreground relative overflow-hidden"
        >
           {/* Decorative elements */}
