...
import { MessageSquarePlus, Bug, Lightbulb, Wrench, Send, Clock, CheckCircle, XCircle, Loader2 } from "lucide-react";
...
/**
 * Página de feedback do usuário
 * Permite enviar sugestões, melhorias e relatórios de erros
 */
const Feedback = () => {
  ...
  return (
    <PageLoader loading={loading} message="Carregando feedbacks...">
