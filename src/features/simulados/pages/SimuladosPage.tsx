...
import { NewSimuladoDialog } from "../components/NewSimuladoDialog";
import { SimuladoHistoryCard } from "../components/SimuladoHistoryCard";
  ...
  return (
    <div className="min-h-screen bg-background app-layout-container">
      ...
      <main className="max-w-7xl lg:ml-0 lg:mr-auto px-4 sm:px-6 lg:px-8 py-8">
        <PageLoader loading={premiumLoading || loading} variant="cards">
          <motion.div
          ...
          >
            ...
            <PageHeader
              ...
              description="Pratique com simulados completos e acompanhe seu progresso"
              icon={FileText}
              actions={
                <div className="flex items-center gap-2" data-tour="simulados-actions">
                  <Button onClick={() => setDialogOpen(true)} size="sm" className="gap-2 shadow-sm">
...
export const SimuladosPage = Simulados;
