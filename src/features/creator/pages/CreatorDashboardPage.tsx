...
import PixKeySection from "../components/PixKeySection";
        ...
        <PageLoader loading={loading} variant="dashboard">
          {!isCreator ? (
            <div className="text-center py-16 space-y-4">
              ...
              <h2 className="text-2xl font-bold">Acesso Restrito ao Plano Criador</h2>
              <p className="text-muted-foreground max-w-md mx-auto">
                Este painel é exclusivo para criadores parceiros do Aprendify.
              </p>
