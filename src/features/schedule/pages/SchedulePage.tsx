...
import WeeklyAdherenceReport from "../components/WeeklyAdherenceReport";
import WeeklyAgendaView from "../components/WeeklyAgendaView";
import SubjectProgressCircles from "../components/SubjectProgressCircles";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-primary/3 app-layout-container">
      ...
      <main className="max-w-7xl lg:ml-0 lg:mr-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
        <PageLoader loading={loading} variant="default">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          {/* Header Minimalista Padronizado */}
          <div className="mb-5">
            <PageHeader
              title="Plano de Estudos"
              description="Monte e gerencie sua própria rotina de estudos"
              icon={BookOpen}
              actions={
